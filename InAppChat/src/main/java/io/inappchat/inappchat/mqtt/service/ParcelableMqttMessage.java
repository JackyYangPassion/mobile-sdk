 ...
 *
 * <p>An application will probably use this only when receiving a message from a Service in a Bundle
 * - the necessary code will be something like this :-
 *
 * <pre>
 * <code>
 ...
 * </pre>
 *
 * <p>It is unlikely that an application will directly use the methods which are specific to this
 * class.
 */
public class ParcelableMqttMessage extends MqttMessage implements Parcelable {
  ...
  public static final Creator<ParcelableMqttMessage> CREATOR =
      new Creator<ParcelableMqttMessage>() {
