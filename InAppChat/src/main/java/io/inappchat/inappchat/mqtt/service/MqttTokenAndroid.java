...
/**
 * Implementation of the IMqttToken interface for use from within the MqttAndroidClient
 * implementation
 */
class MqttTokenAndroid implements IMqttToken {
   ...
   * @param listener optional listener that will be notified when the action completes. Use null if
   * not required.
   */
