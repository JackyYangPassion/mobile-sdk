...
/**
 * Various strings used to identify operations or data in the Android MQTT service, mainly used in
 * Intents passed between Activities and the Service.
 */
interface MqttServiceConstants {
  ...
  /* Tags for actions passed between the Activity and the Service */ String SEND_ACTION = "send";
  ...
  /* Identifies an Intent which calls back to the Activity */ String CALLBACK_TO_ACTIVITY =
      MqttService.TAG + ".callbackToActivity" + "." + VERSION;

  /* Identifiers for extra data on Intents broadcast to the Activity */ String CALLBACK_ACTION =
      MqttService.TAG + ".callbackAction";
