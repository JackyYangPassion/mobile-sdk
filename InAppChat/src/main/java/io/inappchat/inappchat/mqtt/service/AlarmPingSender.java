 ...
 *
 * <p>This class implements the {@link MqttPingSender} pinger interface allowing applications to
 * send ping packet to server every keep alive interval.
 *
 * @see MqttPingSender
 */
class AlarmPingSender implements MqttPingSender {
  // Identifier for Intents, log messages, etc..
  private static final String TAG = Constants.TAG + " : AlarmPingSender";
  ...
  class AlarmReceiver extends BroadcastReceiver {
    ...
    private final String wakeLockTag =
        MqttServiceConstants.PING_WAKELOCK + that.comms.getClient().getClientId();
