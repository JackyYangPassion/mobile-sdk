...
import io.inappchat.inappchat.utils.Constants.Features.DELETE
import io.inappchat.inappchat.utils.Constants.Features.EDIT
import io.inappchat.inappchat.utils.Constants.Features.SELF
import io.inappchat.inappchat.utils.Constants.Features.THIS_MESSAGE_WAS_DELETED
import io.inappchat.inappchat.utils.Constants.Features.THIS_MESSAGE_WAS_DELETED_FOR_YOU
...
class ChatWrapper(private val dataManager: DataManager, private val eventHandler: EventHandler) {
  ...
  private fun isE2EFeatureEnabled(): Boolean {
    return (dataManager.db().tenantDao().getFeatureEnabled(dataManager.preference().tenantId, io.inappchat.inappchat.utils.Constants.TenantConfig.E2E_CHAT) == "1")
  }
  ...
  private fun getConfigList(
    ...
    if (deleteChat != null) {
      ...
      configArrayList.add(
        TenantConfig(tenant.id, io.inappchat.inappchat.utils.Constants.TenantConfig.DELETE_CHAT, "0")
      )
      configArrayList.add(
        TenantConfig(
          tenant.id,
