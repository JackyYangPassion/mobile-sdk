...
object Deps {
  ...
  object Module {
    val coreSdk = ":ripbull-chat-sdk"
    val permission = ":permissions"
    val coreAttachment = ":coreAttachment"
    val newRelic = ":new-relic-log"
    val mqtt = "com.ripbull.ertc.mqtt:sdk-mqtt:${Version.sub_module_release_version}"
    val remote = "com.ripbull.ertc.remote:sdk-remote:${Version.sub_module_release_version}"
    val cache = "com.ripbull.ertc.cache:sdk-cache:${Version.sub_module_release_version}"
    val downloader = "com.ripbull.sdk.downloader:sdk-downloader:${Version.sub_module_release_version}"
    val ripbull_chat_sdk = "com.ripbull.coresdk:ripbull-chat-sdk:1.1.0.release-rc1@aar"
  }
  ...
  object External {
    ...
    val giphySDK = "com.giphy.sdk:ui:2.2.0"
  }
  ...
  object Mqtt {
    val client = "org.eclipse.paho:org.eclipse.paho.client.mqttv3:1.2.5"
  }
  ...
  object Compressor {
    val mp4Parser = "com.googlecode.mp4parser:isoparser:1.0.6"
    val coroutinesCore = "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.4.3"
    val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.4.3"
  }
}
