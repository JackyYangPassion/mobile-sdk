...
object Version {
  ...
  const val firebase_perf = "16.2.3"
  ...
  const val androidx_113 = "1.1.3"
  const val materialDesign = "1.6.1"
  const val emoji_version = "1.0.0"
  const val sub_module_release_version = "1.1.1.release-rc1@aar"
}