...
import com.ripbull.coresdk.chat.repository.ChatRepositoryImpl.Companion.newInstance
import com.ripbull.coresdk.chat.repository.ChatRestoreRepository
import com.ripbull.coresdk.chat.repository.ChatRestoreRepositoryImpl
import com.ripbull.coresdk.chat.repository.FavoriteMsgRepositoryImpl
import com.ripbull.coresdk.chat.repository.FavoriteMsgRepository
...
import com.ripbull.coresdk.download.DownloadRepositoryImpl
...
import com.ripbull.coresdk.thread.handler.ThreadRepositoryImpl
...
class ChatModuleImpl private constructor(
  ...
  override fun getThreads(): Flowable<MutableList<ThreadRecord>> {
    return withTenant<Flowable<MutableList<ThreadRecord>>>(
  ...
  override fun createThread(recipientId: String): Single<String> {
    ...
    return userDao.hasUser(tenantId, recipientId).flatMap { recipientUserList ->
      if(recipientUserList.size <= 0 ){
        recipientUser = Single.just(User(id = recipientId, tenantId = tenantId, name = "Third party user"))
      }
      Single.zip(currentUser,
        recipientUser,
        { current: User?, recipient: User? ->
        ...
        .flatMap { single: Single<String?>? -> single }
    }
  }
  ...
  override fun getMessages(
    ...
    return chatRepository.getMessages(tenantId, threadId, currentMsgId, direction, pageSize, isGlobalSearched)
  }
  ...
  override fun sendE2EMessage(
    ...
    return chatRepository.sendE2EMessage(message, tenantId, threadId, deviceId, customData = customData)
  }
  ...
  override fun getMediaGallery(
    ...
    mediaType.put("video")
    mediaType.put("audio")
    return chatRepository.getMediaGallery(tenantId, threadId, mediaType.toString(), currentMsgId, direction, pageSize)
  }
  ...
  override fun forwardMediaChat(
    ...
    return chatRepository.forwardMediaChat(tenantId, message, userList, groupList, deviceId, chatType, customData)
  }
  ...
  override fun getFollowThreads(
    ...
    return chatRepository.getFollowThreads(threadId, currentMsgId, followedThread, direction, pageSize)
  }
  ...
  companion object {
    fun newInstance(
      ...
      return ChatModuleImpl(dataManager, chatRepository, threadRepository, favMsgRepository,chatRestoreRepository)
    }
  }
