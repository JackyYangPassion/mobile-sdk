...
import com.ripbull.coresdk.user.model.UserDBUpdate;
...
import com.ripbull.coresdk.wrappers.ChatWrapper;
import com.ripbull.coresdk.wrappers.MessageWrapper;
import com.ripbull.coresdk.wrappers.ThreadWrapper;
...
//      eventSource.onNext(NetworkEvent.userMetaUpdated(message));
      ...
      if (eventItem.getEventType().equals(com.ripbull.coresdk.utils.Constants.THREAD_NOTIFICATION_SETTINGS_CHANGED)) {
        threadWrapper
            ...
            .subscribe(new CrashReportingObserver<>(disposableList));
      } else if (eventItem.getEventType().equals(com.ripbull.coresdk.utils.Constants.GLOBAL_NOTIFICATION_SETTINGS_CHANGED)) {
        userWrapper
            ...
            .subscribe(new CrashReportingObserver<>(disposableList));
      } else if (eventItem.getEventType().equals(com.ripbull.coresdk.utils.Constants.AVAILABILITY_STATUS_CHANGED)) {
        userWrapper
            .userSelfAvailabilityUpdated(eventItem)
            .doOnNext(userMetaDataRecord -> eventSource.onNext(NetworkEvent.userMetaDataUpdated(userMetaDataRecord)))
            .subscribe(new CrashReportingObserver<>(disposableList));
      } else if (eventItem.getEventType().equals(com.ripbull.coresdk.utils.Constants.USER_BLOCKED_STATUS_CHANGED)) {
        userWrapper
