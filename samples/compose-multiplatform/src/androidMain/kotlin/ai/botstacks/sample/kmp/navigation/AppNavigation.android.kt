...
import ai.botstacks.sample.kmp.navigation.BottomSheetNavigator
import ai.botstacks.sample.kmp.navigation.LocalPlatformNavigator
...
actual fun AppNavHost(content: @Composable () -> Unit) {
    BottomSheetNavigator(
        ...
        sheetContent = {
            val navigator = remember(it) { ai.botstacks.sample.kmp.navigation.PlatformNavigator(it) }
