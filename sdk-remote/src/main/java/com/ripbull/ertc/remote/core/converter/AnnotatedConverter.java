...
public final class AnnotatedConverter extends Converter.Factory {
  ...
  public static final class Builder {
    ...
    public AnnotatedConverter build() {
      return new AnnotatedConverter(factories);
    }
  }

  private AnnotatedConverter(Map<Class<? extends Annotation>, Converter.Factory> factories) {
